...
const char* MessageHandler::prepare_connack_message(int& reply_offset)
{
...
const char* MessageHandler::prepare_listreply_message(vector<USER_ID_TYPE> user_list, int& reply_offset)
{
    char* reply = prepare_buffer(BUFFER_SIZE);
...
const char* MessageHandler::prepare_inforeply_message(string user_name, int& reply_offset)
{
    char* reply = prepare_buffer(BUFFER_SIZE);
    ...
    reply_offset += user_name.length();
    return reply;
}

const char* MessageHandler::prepare_sendreply_message(USER_STATUS_TYPE status, int& reply_offset)
{
    char* reply = prepare_buffer(BUFFER_SIZE);
    ...
    reply_offset += (int)sizeof(status);
    return reply;
}

const char* MessageHandler::prepare_recievereply_message(Message* message, int& reply_offset)
{
    char* reply = prepare_buffer(BUFFER_SIZE);
    ...
    reply_offset += content.length();
    return reply;
}

const char* MessageHandler::prepare_connect_message(string user_name, int& reply_offset)
{
    char* reply = prepare_buffer(BUFFER_SIZE);
...
const char* MessageHandler::prepare_list_message(int& reply_offset)
{
    char* reply = prepare_buffer(BUFFER_SIZE);
...
const char* MessageHandler::prepare_info_message(USER_ID_TYPE user_id, int& reply_offset)
{
    char* reply = prepare_buffer(BUFFER_SIZE);
...
const char* MessageHandler::prepare_send_message(USER_ID_TYPE user_id, string content, int& reply_offset)
{
    char* reply = prepare_buffer(BUFFER_SIZE);
...
const char* MessageHandler::prepare_recieve_message(int& reply_offset)
{
    char* reply = prepare_buffer(BUFFER_SIZE);
